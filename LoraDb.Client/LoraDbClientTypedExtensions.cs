...
public static class LoraDbClientTypedExtensions
{
    ...
    /// </summary>
    /// <remarks>
    /// The entire response is fetched in a single round-trip and deserialized into an intermediate
    /// list. The rows are then yielded one at a time, which allows callers to use
    /// <c>await foreach</c> and LINQ-style lazy processing.
    /// </remarks>
